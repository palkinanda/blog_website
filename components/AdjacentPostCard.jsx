...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    {position === "LEFT" && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-[#f53145] left-4 rounded-full">
        <svg
    ...
    {position === "RIGHT" && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-[#f53145] right-4 rounded-full">
        <svg
          xmlns="http://www.w3.org/2000/svg"
