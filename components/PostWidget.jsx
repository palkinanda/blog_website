...
const PostWidget = ({ categories, slug }) => {
  ...
  return (
    <div className="bg-white  p-8 pb-12 mb-8">
      <h3 className="mt-[0] mx-[0] mb-[20px] text-[19px] leading-[25px] text-[#232323] tracking-[2px] text-center uppercase font-[aracnereg,Arial,Verdana,sans-serif] font-normal">Checkout our {slug ? 'Related Posts' : 'Recent Posts'}.</h3>
      ...
      {relatedPosts.map((post, index) => (
        <div key={index} className="flex items-center w-full mb-4     cursor-pointer block pb-3 mb-3 box-border m-0 p-0 list-none font-[oswald,Arial,sans-serif] text-[14px] leading-[30px] uppercase font-bold tracking-[1px]
